-- Script para aprovar as 3 perguntas reflexivas do Pr. Marcus no Passo 2
...
BEGIN
    ...
    -- 2. Buscar a entrada de perguntas reflexivas do Passo 2
    ...
    IF v_perguntas_id IS NULL THEN
        RAISE EXCEPTION 'Perguntas reflexivas do Passo 2 não encontradas ou já aprovadas';
    END IF;
    ...
    IF v_progresso_id IS NULL THEN
        RAISE EXCEPTION 'Progresso do Passo 2 não encontrado';
    END IF;
    ...
    INSERT INTO notificacoes (
        ...
        'Suas 3 perguntas reflexivas do Passo 2 foram aprovadas! Você ganhou 90 XP (30 XP por pergunta). Continue seu progresso no próximo passo!',
        false,
        NOW()
    );

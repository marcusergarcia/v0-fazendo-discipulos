...
type ChatDiscipuladorClientProps = {
  userId: string
  discipuloId: string
  discipuloUserId: string
  discipuloNome: string
  mensagensIniciais: Mensagem[]
}

export default function ChatDiscipuladorClient({
  userId,
  discipuloId,
  discipuloUserId,
  discipuloNome,
  mensagensIniciais,
}: ChatDiscipuladorClientProps) {
  ...
  }, [supabase, discipuloId, discipuloUserId])

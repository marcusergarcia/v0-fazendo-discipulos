        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4 mb-6 max-h-96 overflow-y-auto">
              {mensagens && mensagens.length > 0 ? (
                mensagens.map((msg) => (
                  ...
                  >
                    <p className="text-sm font-medium mb-1">{msg.remetente_id === user.id ? "Você" : "Discipulador"}</p>
            ...
            <form action={enviarMensagem} className="space-y-3">
              <Textarea name="mensagem" placeholder="Digite sua mensagem..." className="min-h-24" required />

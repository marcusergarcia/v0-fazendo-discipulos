...
export default function Page() {
  ...
  const handleFacebookLogin = async () => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : "Erro ao fazer login com Facebook")
      setIsLoading(false)
    }
  }
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-transparent px-2 text-blue-200">Ou continue com email</span>
                    </div>
                  </div>
